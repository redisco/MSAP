...
import ua.com.msap.core.links.readers.PlusReader;
 ...
 * @author Neredko Mick 
 */
public class Plus extends Link {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 41 * hash + (this.k != null ? this.k.hashCode() : 0);
        return hash;
    }
    ...
    public LinkReader getLinkReader() {
        return (LinkReader) new PlusReader();
    }
}
